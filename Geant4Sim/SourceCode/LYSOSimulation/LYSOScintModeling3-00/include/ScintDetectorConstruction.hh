...
// ********************************************************************
//
// $Id: ScintDetectorConstruction.hh 75215 2013-10-29 16:07:06Z gcosmo $
// 
/// \file ScintDetectorConstruction.hh
/// \brief Definition of the ScintDetectorConstruction class
...
///
/// In ConstructSDandField() sensitive detectors of ScintCalorimeterSD type
/// are created and associated with the Absorber and Gap volumes.
/// In addition a transverse uniform magnetic field is defined 
/// via G4GlobalMagFieldMessenger class.

class ScintDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    ScintDetectorConstruction();
    virtual ~ScintDetectorConstruction();
